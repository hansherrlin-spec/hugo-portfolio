...
export default function CastingProfile() {
  ...
  return (
    <section id="profil" className="py-24 px-6 bg-neutral-900/50">
      <div className="max-w-3xl mx-auto">
        <p className="text-red-500 font-semibold text-sm uppercase tracking-widest mb-3">
          Casting
        </p>
        <h2 className="text-3xl md:text-4xl font-bold mb-2 text-white">Casting-profil</h2>
        <p className="text-neutral-500 mb-10">
          Snabb överblick för casting directors och producenter.
        </p>

        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-10">
          <div className="border border-neutral-800 rounded-xl p-5 bg-neutral-900 text-center">
          ...
          <div className="border border-neutral-800 rounded-xl p-5 bg-neutral-900 text-center col-span-2 md:col-span-1">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-10">
          {physicalFields.map(({ key, label, icon: Icon }) => {
            ...
            return (
              <div
                key={key}
                className="flex items-center gap-3 border border-neutral-800 rounded-lg p-3.5 bg-neutral-900"
              >
        ...
        <div className="text-center pt-8 border-t border-neutral-800">
          ...
          <a
            href="#kontakt"
            className="inline-flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-full font-semibold transition-colors shadow-lg shadow-red-950/50"
          >
